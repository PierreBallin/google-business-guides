...
const faqItems = [
  { q: 'Quel est le prix moyen d\'un vidéaste mariage en Bretagne ?', a: 'En Bretagne (35, 44, 56), le prix d\'un vidéaste mariage professionnel se situe généralement entre 800 € et 2 500 €. La fourchette basse (800–1 000 €) correspond à un film highlights de 3–5 minutes avec un seul cadreur. La fourchette haute (1 800–2 500 €) inclut deux cadreurs, des prises de vue par drone, un film intégral de la journée et des livrables premium (clé USB, tirage). Notre formule Prestige à 1 290 € est la plus populaire, car elle offre le meilleur rapport qualité/souvenir.' },
  ...
  { q: 'Pourquoi existe-t-il de si grandes différences de prix ?', a: 'Plusieurs facteurs expliquent les écarts tarifaires : l\'expérience du vidéaste (un débutant vs. 5+ ans de carrière), la qualité du matériel (caméras mirrorless pro vs. entrée de gamme), le temps de montage (de 10h à 60h+), le nombre de cadreurs, et les livrables inclus. Un prix très bas (< 600 €) doit interpeller : contrat ? assurance pro ? matériel de backup ? Un vidéaste professionnel investit lourdement dans son équipement et sa formation — ce coût se reflète dans le tarif.' },
        ...
        <div style={{ background: CARD_BG, border: `1px solid ${GOLD}`, borderRadius: '12px', padding: '32px 28px', marginBottom: '40px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px' }}>
            {[
              ...
              { fourchette: '1 500 € – 2 500 €', label: 'Haut de gamme', desc: '2 cadreurs, drone, film 7 min + intégral complet' },
              { fourchette: '2 500 € +', label: 'Premium / sur mesure', desc: 'Multi-cadreurs, format long, live streaming' },
            ].map((r, i) => (
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
            {[
              ...
              { name: 'Cinéma', price: '1 790 €', detail: '2 cadreurs · Drone · Film 7 min + intégral', href: '/tarifs-videaste-mariage' },
            ].map((f, i) => (
      ...
      <section id="contact" style={{ padding: '72px 20px', background: 'linear-gradient(160deg, #0a0908, #080808)', borderTop: '1px solid rgba(201,169,110,0.15)' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', maxWidth: '420px', margin: '0 auto 24px' }}>
            ...
            <input placeholder="Date de mariage & lieu (département)" style={{ background: '#111', border: `1px solid ${BORDER}`, borderRadius: '6px', padding: '14px 16px', color: CREAM, fontSize: '14px', fontFamily: 'Georgia, serif', outline: 'none' }} />
