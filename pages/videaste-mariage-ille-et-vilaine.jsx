  ...
  return (
    ...
    >
      ...
      <section style={{ position: 'relative', overflow: 'hidden', borderBottom: '1px solid rgba(201,169,110,0.1)' }}>
        <img src="/images/hero/hero-mariage-ille-et-vilaine.webp" alt="Vidéaste mariage Ille-et-Vilaine — film cinématographique département 35" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center', zIndex: 0 }} />
