  ...
  return (
    ...
    >
      ...
      <section style={{ position: 'relative', overflow: 'hidden', borderBottom: '1px solid rgba(201,169,110,0.1)' }}>
        <img src="/images/hero/hero-mariage-loire-atlantique.webp" alt="Vidéaste mariage Loire-Atlantique — film cinématographique département 44" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center', zIndex: 0 }} />
      ...
      <section id="contact" style={{ padding: '72px 20px', background: 'linear-gradient(160deg, #0a0908, #080808)', borderTop: '1px solid rgba(201,169,110,0.15)' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <QuickContactForm locationHint="Loire-Atlantique (44)" />
        </div>
      </section>
    </Layout>
  );
